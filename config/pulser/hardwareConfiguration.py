...
class hardwareConfiguration(object):
    ...
    ddsDict = {
        'DDS1': ddsConfiguration(0, (0.0, 800.0), (-48.0, -10.0), 139.77, -17),
        'DDS2': ddsConfiguration(1, (0.0, 800.0), (-48.0, 3.0), 130.0, -48.0),
        'DDS3': ddsConfiguration(2, (0.0, 800.0), (-48.0, 3.0), 220.0, -48.0),
        'DDS4': ddsConfiguration(3, (0.0, 800.00), (-48.0, 3.0), 300.0, -48.0),
        'DDS5': ddsConfiguration(4, (0.0, 800.0), (-48.0, -11.0), 100.4, -48.0),
        'DDS6': ddsConfiguration(5, (0.0, 800.0), (-48.0, -18.0), 461.0, -33.0),
        'DDS7': ddsConfiguration(6, (0.0, 800.0), (-48.0, 3.0), 100.0, -48.0),
        'DDS8': ddsConfiguration(7, (0.0, 800.0), (-48.0, 3.0), 100.0, -48.0),
    }
    '''ddsDict = {
