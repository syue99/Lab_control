...
class experiment_phases(experiment):
    ...
    def _initialize(self):
        ...
        if self.parameters['general']['verbose']:
            ...
            print('\ntime per run: ' + str(self.parameters['general']['seqLen'] * self.parameters['general']['nLoops']) + ' seconds')
    ...
    def _dophases(self):
        ...
        for p in self.phases_flat_sorted:
            p.dophase(self.cxn, self.parameters[type(p).__name__])
    ...
    def _loopWhileRunWaveform(self):
        scanTime = self.parameters['general']['seqLen'] * self.parameters['general']['nLoops']
        print("scacntime: "+str(scanTime))
