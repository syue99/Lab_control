...
with labrad.connect() as cxn:
    ...
    DDS = [
        ...
        #Group 1 Raman beams
        	('DDS1', WithUnit(0.1, 'ms'), WithUnit(50, 'us'), WithUnit(145, 'MHz'), WithUnit(-23.0, 'dBm'), WithUnit(0.0, 'deg'), WithUnit(0, 'MHz'),WithUnit(-10, 'dB')),
	        #('DDS1', WithUnit(450, 'us'), WithUnit(70, 'us'), WithUnit(145, 'MHz'), WithUnit(-20.0, 'dBm'), WithUnit(0.0, 'deg'), WithUnit(0, 'MHz'),WithUnit(-10, 'dB')),
            #('DDS1', WithUnit(600, 'us'), WithUnit(272, 'us'), WithUnit(145, 'MHz'), WithUnit(-23.0, 'dBm'), WithUnit(0.0, 'deg'), WithUnit(0, 'MHz'),WithUnit(-10, 'dB')),
            #('DDS1', WithUnit(950, 'us'), WithUnit(70, 'us'), WithUnit(145, 'MHz'), WithUnit(-20.0, 'dBm'), WithUnit(0.0, 'deg'), WithUnit(0, 'MHz'),WithUnit(-10, 'dB')),
        	('DDS5', WithUnit(0.1, 'ms'), WithUnit(10, 'us'), WithUnit(145, 'MHz'), WithUnit(-23.0, 'dBm'), WithUnit(76.0, 'deg'), WithUnit(0, 'MHz'),WithUnit(-10, 'dB')),
            ('DDS5', WithUnit(0.12, 'ms'), WithUnit(10, 'us'), WithUnit(130, 'MHz'), WithUnit(-23.0, 'dBm'), WithUnit(76.0, 'deg'), WithUnit(0, 'MHz'),WithUnit(-10, 'dB')),
	        ('DDS5', WithUnit(0.14, 'ms'), WithUnit(10, 'us'), WithUnit(145, 'MHz'), WithUnit(-23.0, 'dBm'), WithUnit(76.0, 'deg'), WithUnit(0, 'MHz'),WithUnit(-10, 'dB')),
            #('DDS5', WithUnit(450, 'us'), WithUnit(70, 'us'), WithUnit(145, 'MHz'), WithUnit(-20.0, 'dBm'), WithUnit(30.0, 'deg'), WithUnit(0, 'MHz'),WithUnit(-10, 'dB')),
            #('DDS5', WithUnit(600, 'us'), WithUnit(272, 'us'), WithUnit(145, 'MHz'), WithUnit(-23.0, 'dBm'), WithUnit(30.0, 'deg'), WithUnit(0, 'MHz'),WithUnit(-10, 'dB')),
            #('DDS5', WithUnit(950, 'us'), WithUnit(70, 'us'), WithUnit(145, 'MHz'), WithUnit(-20.0, 'dBm'), WithUnit(30.0, 'deg'), WithUnit(0, 'MHz'),WithUnit(-10, 'dB')),
