...
ncCamGetRawEmGainRange.argtypes = [NCCAM, c_int, POINTER(c_int)]
...
ncCamGetCalibratedEmGain.argtypes = [NCCAM, POINTER(c_int), POINTER(c_int)]
...
ncCamGetCalibratedEmGainRange.argtypes = [NCCAM, c_int, POINTER(c_int)]
...
ncCamParamAvailable = nuvuLib.ncCamParamAvailable
ncCamParamAvailable.restype = c_int
ncCamParamAvailable.argtypes = [NCCAM,c_int,c_int]

# safe shut down
shutdown_callback = CFUNCTYPE(c_int, c_double, c_double)
ncCamParamAvailable = nuvuLib.ncCamPrepareShutdown
ncCamParamAvailable.restype = c_int
ncCamParamAvailable.argtypes = [NCCAM,c_int,shutdown_callback]

# get analog offest
ncCamGetAnalogOffset = nuvuLib.ncCamGetAnalogOffset
ncCamGetAnalogOffset.restype = c_int
ncCamGetAnalogOffset.argtypes = [NCCAM, c_int, POINTER(c_int)]

# set analog offset
ncCamSetAnalogOffset = nuvuLib.ncCamSetAnalogOffset
ncCamSetAnalogOffset.restype = c_int
ncCamSetAnalogOffset.argtypes = [NCCAM, c_int]

# get analog gain
ncCamGetAnalogGain = nuvuLib.ncCamGetAnalogGain
ncCamGetAnalogGain.restype = c_int
ncCamGetAnalogGain.argtypes = [NCCAM, c_int, POINTER(c_int)]

# set analog gain
ncCamSetAnalogGain = nuvuLib.ncCamSetAnalogGain
ncCamSetAnalogGain.restype = c_int
ncCamSetAnalogGain.argtypes = [NCCAM, c_int]
...
# cancel bias creation
ncCamCancelBiasCreation = nuvuLib.ncCamCancelBiasCreation
ncCamCancelBiasCreation.restype = c_int
ncCamCancelBiasCreation.argtypes = [NCCAM]

# get bias clamp level
ncCamGetBiasClampLevel = nuvuLib.ncCamGetBiasClampLevel
ncCamGetBiasClampLevel.restype = c_int
ncCamGetBiasClampLevel.argtypes = [NCCAM, POINTER(c_int)]

# set bias clamp level
ncCamSetBiasClampLevel = nuvuLib.ncCamSetBiasClampLevel
ncCamSetBiasClampLevel.restype = c_int
ncCamSetBiasClampLevel.argtypes = [NCCAM, c_int]
...
# setBinning
ncCamSetBinningMode = ncCamSetBinningMode
ncCamSetBinningMode.restype = c_int
ncCamSetBinningMode.argtypes = [NCCAM, c_int, c_int]