...
class repeat_reload(experiment):
    """Repeats an experiment multiple times, while reloading the parameters every repeatition."""
    ...
    def update_progress(self, iteration):
        progress = self.min_progress + \
            (self.max_progress - self.min_progress) * float(iteration + 1.0) / self.repetitions
