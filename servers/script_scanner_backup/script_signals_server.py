...
class ScriptSignalsServer(LabradServer):
    ...
    on_running_script_finished_error = Signal(
        200006, "signal_on_running_script_finished_error", 'ws')

    # queued scripts
    on_queued_new_script = Signal(200010, "signal_on_queued_new_script",
                                  'wsw')  # identification, name, order
