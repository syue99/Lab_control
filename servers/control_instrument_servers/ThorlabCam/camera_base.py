...
def camera_dot_net_process_entry(
    ...
    from camera_dot_net import ThorCamServer
...
class ThorCam(ThorCamClient):
    ...
    """
    cam_data = None
    """An one-dim 2*1920*1080 numpy array that captures the last picture taken by the camera
    """
    cam_data_info = None
    """An one-dim 2 list that captures the last picture taken by the camera
    """
    ...
    def got_image(self, image, count, queued_count, t):
        ...
        """
        self.cam_data = image
        self.cam_data_info = [count, t]
        return

    
    #A function that return image
    def return_img(self):
