...
DDS = [('DDS_0', WithUnit(0.1, 'ms'), WithUnit(0.002, 'ms'), WithUnit(2.0, 'MHz'),
        WithUnit(-20.0, 'dBm'), WithUnit(0.0, 'deg'), WithUnit(0, 'MHz')),
       ('DDS_0', WithUnit(0.102, 'ms'), WithUnit(5.0, 'ms'), WithUnit(5.0, 'MHz'),
        WithUnit(-20.0, 'dBm'), WithUnit(0.0, 'deg'), WithUnit(0.6, 'MHz')),
       ('DDS_0', WithUnit(5.102, 'ms'), WithUnit(0.002, 'ms'), WithUnit(5.0, 'MHz'),
        WithUnit(-20.0, 'dBm'), WithUnit(0.0, 'deg'), WithUnit(0.0, 'MHz')),
       ('DDS_0', WithUnit(5.104, 'ms'), WithUnit(5.0, 'ms'), WithUnit(2.0, 'MHz'),
        WithUnit(-20.0, 'dBm'), WithUnit(0.0, 'deg'), WithUnit(1.5, 'MHz'))
       ]
