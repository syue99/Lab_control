...
DDS = [
    ('DDS_0', WithUnit(0.1, 'ms'), WithUnit(999.9, 'ms'), WithUnit(85.0, 'MHz'),
     WithUnit(-20.0, 'dBm'), WithUnit(0.0, 'deg'), WithUnit(0, 'MHz')),
    ('DDS_0', WithUnit(1000, 'ms'), WithUnit(6000, 'ms'), WithUnit(88.0, 'MHz'),
     WithUnit(-20.0, 'dBm'), WithUnit(0.0, 'deg'), WithUnit(0.01, 'MHz'))]
