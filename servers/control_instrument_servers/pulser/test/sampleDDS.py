...
class sampleDDS(pulse_sequence):
    ...
    def sequence(self):
        ...
        self.addDDS('DDS_0', WithUnit(0.1, 'ms'), WithUnit(250, 'ms'),
                    WithUnit(85.0, 'MHz'), WithUnit(-23.0, 'dBm'))
        self.addDDS('DDS_0', WithUnit(500, 'ms'), WithUnit(250, 'ms'),
                    WithUnit(85.0, 'MHz'), WithUnit(-23.0, 'dBm'))
        self.addDDS('DDS_1', WithUnit(1000, 'ms'), WithUnit(100, 'ms'),
                    WithUnit(88.0, 'MHz'), WithUnit(-40.0, 'dBm'))
        self.addDDS('DDS_1', WithUnit(2000, 'ms'), WithUnit(2000, 'ms'),
                    WithUnit(87.0, 'MHz'), WithUnit(-40.0, 'dBm'))
