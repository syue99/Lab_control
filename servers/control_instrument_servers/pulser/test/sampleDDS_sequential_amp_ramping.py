...
DDS = [('DDS_0', WithUnit(0.1, 'ms'), WithUnit(199.9, 'ms'), WithUnit(88.0, 'MHz'),
        WithUnit(-63, 'dBm'), WithUnit(0.0, 'deg'), WithUnit(0.0, 'MHz'), no_amp_ramp),
       ('DDS_0', WithUnit(200.0, 'ms'), WithUnit(2300.0, 'ms'), WithUnit(92.0, 'MHz'),
        WithUnit(-20, 'dBm'), WithUnit(0.0, 'deg'), WithUnit(0.003, 'MHz'), WithUnit(0.05, 'dB')),
       ('DDS_0', WithUnit(2500.0, 'ms'), WithUnit(2300.0, 'ms'), WithUnit(88.0, 'MHz'),
        WithUnit(-62, 'dBm'), WithUnit(0.0, 'deg'), WithUnit(0.003, 'MHz'), WithUnit(0.05, 'dB')),
       ('DDS_1', WithUnit(0.1, 'ms'), WithUnit(199.9, 'ms'), WithUnit(86.0, 'MHz'),
        WithUnit(-63, 'dBm'), WithUnit(0.0, 'deg'), WithUnit(0.0, 'MHz'), no_amp_ramp),
       ('DDS_1', WithUnit(200.0, 'ms'), WithUnit(2300.0, 'ms'), WithUnit(82.0, 'MHz'),
        WithUnit(-20, 'dBm'), WithUnit(0.0, 'deg'), WithUnit(0.003, 'MHz'), WithUnit(0.05, 'dB')),
       ('DDS_1', WithUnit(2500.0, 'ms'), WithUnit(2300.0, 'ms'), WithUnit(86.0, 'MHz'),
        WithUnit(-62, 'dBm'), WithUnit(0.0, 'deg'), WithUnit(0.003, 'MHz'), WithUnit(0.05, 'dB'))
       ]
