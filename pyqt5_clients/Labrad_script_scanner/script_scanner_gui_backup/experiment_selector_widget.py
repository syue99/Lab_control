...
class scan_dialog(QtWidgets.QDialog, dialog_ui):
    ...
    def on_parameter_picked(self, index):
        ...
        print(minim, maxim, start, stop, steps, units)
    ...
    def updateResolutionSteps(self):
        """Calculates and updates the resolution or the steps depending on which is locked."""
...
class experiment_selector_widget(QtWidgets.QWidget):
    ...
    def run_emit_selected(self):
        """Gets called when the "Run" button is pressed.
