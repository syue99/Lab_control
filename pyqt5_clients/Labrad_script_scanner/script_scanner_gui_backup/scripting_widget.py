...
from sequence_plotter_widget import sequence_plotter_widget
...
class scripting_widget(QtWidgets.QWidget):
    ...
    def setupLayout(self):
        ...
        #self.sequence_plotter_window = QtWidgets.QMainWindow()
        #self.sequence_plotter = sequence_plotter_widget()
        #self.sequence_plotter.setup_code_serarch(self.sequence_plotter_window)
        layout.addWidget(self.selector)
        layout.addWidget(self.scheduled)
        layout.addWidget(self.queued)
        layout.addWidget(self.running)
        #layout.addWidget(self.sequence_plotter)
