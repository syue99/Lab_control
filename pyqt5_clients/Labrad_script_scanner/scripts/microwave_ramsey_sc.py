...
class scan(experiment):
    ...
    required_parameters = [('cam_roi', 'height'),
                           ...
                           ('Microwave', 'mw_detuning'),
                           ('Microwave', 'mw_pi_time'),
                           ('Microwave', 'mw_pwr'),
                           ('Microwave', 'Ramsey_evolution_time'),
                           ('scan_use_pmt', 'USEPMT')
                           ]
    USEPMT = False
    continue_flag = False
    ...
    def program_main_sequence(self, scanfreq, scantime):
        ...
        pi_over_2_time = microwave_pi_time / 2
        # print(pi_over_2_time)
        period1_start_at = 0.01
        microwave_pulse1_start_at = period1_start_at + pump1 + DDS_wait_time1
        microwave_pulse2_start_at = microwave_pulse1_start_at + pi_over_2_time + scantime
        detection_start_at = microwave_pulse2_start_at + pi_over_2_time + DDS_wait_time2
        # detection_start_at = microwave_pulse2_start_at + pi_over_2_time
        # this is always needed if you want to start a new sequence
        self.pulser.new_sequence()
        ...
        DDS = [
            ...
            # microwave
            ('Microwave', WithUnit(microwave_pulse1_start_at, 'ms'), WithUnit(pi_over_2_time, 'ms'),
             WithUnit(scanfreq, 'MHz'), WithUnit(microwave_amp, 'dBm'), WithUnit(0.0, 'deg'), WithUnit(0, 'MHz'),
             WithUnit(0, 'dB')),


            ('Microwave', WithUnit(microwave_pulse2_start_at, 'ms'), WithUnit(pi_over_2_time, 'ms'),
             WithUnit(scanfreq, 'MHz'), WithUnit(microwave_amp, 'dBm'), WithUnit(0.0, 'deg'), WithUnit(0, 'MHz'),
             WithUnit(0, 'dB')),
    ...
    def run(self, cxn, context, scanvalue, units):
        ...
        detuning = self.parameters.Microwave.mw_detuning
        Scan_Freq = self.parameters.Microwave.mw_resonance_freq - detuning
