...
DDS_wait_time1 = 0.01
DDS_wait_time2 = 0.01
detection = 0.1 # 1ms . no too long . avoid far detuned population
...
class scan(experiment):
    ...
    required_parameters = [('cam_roi', 'height'),
                           ...
                           ('MicrowaveHyperfine', 'hpf_scanfreq'),
                           ('MicrowaveHyperfine', 'hpf_scantime'),
                           ('MicrowaveHyperfine', 'scan_use_detuning'),
                           ('scan_use_pmt', 'USEPMT')
                           ]
    USEPMT = False
    continue_flag = False
    ...
    def program_main_sequence(self, scanfreq, scantime):
        ...
        microwave_hyperfine_start = microwave1_start_at + microwave_pi_time + DDS_wait_time2
        microwave2_start_at = microwave_hyperfine_start + scantime + DDS_wait_time2
        ...
        DDS = [
            ...
            ('Microwave', WithUnit(microwave1_start_at, 'ms'), WithUnit(microwave_pi_time, 'ms'),
             ...
             WithUnit(0, 'dB')),
            # microwave_hyperfine
            ('Microwave', WithUnit(microwave_hyperfine_start, 'ms'), WithUnit(scantime, 'ms'),
    ...
    def run(self, cxn, context, scanvalue, units):
        ...
        usedetuning = self.parameters.MicrowaveHyperfine.scan_use_detuning
        if usedetuning:
            ...
            Scan_Freq = self.parameters.MicrowaveHyperfine.hpf_resonance_freq
        Scan_Time = self.parameters.MicrowaveHyperfine.hpf_pi_time
