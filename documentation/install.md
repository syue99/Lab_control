...
* You will need to change directory to C:\Users\scientist\Anaconda3\envs\code3\Lib\site-packages\ok and change all the files there with all files in ok_backup from the environment branch (will set up later) or back_up packages in the lab NAS system.
